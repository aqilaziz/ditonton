...
class _MovieDetailPageState extends State<MovieDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BlocBuilder<MovieDetailCubit, int>(
        builder: (context, stateVersion) {
          final provider = context.read<MovieDetailCubit>();
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                ...
                                final message = detailCubit.watchlistMessage;
                            ...
                            BlocBuilder<MovieDetailCubit, int>(
                              builder: (context, stateVersion) {
                                final data = context.read<MovieDetailCubit>();
